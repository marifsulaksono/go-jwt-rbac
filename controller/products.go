...
func GetProductById(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"message": "invalid paramater"})
		return
	}
...
func GetProductByCategory(c *gin.Context) {
	...
	products, err := model.GetProductByCategory(id)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func GetProductCategories(c *gin.Context) {
	products, err := model.GetProductCategories()
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func AddProductCategories(c *gin.Context) {
	...
	c.JSON(http.StatusCreated, gin.H{"message": "success create category"})
}
